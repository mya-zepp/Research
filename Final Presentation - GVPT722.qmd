...
mod <- lm(incarceration_impacts_motivation_to_vote ~ length_in_this_facility + ever_voted + identifies_as_hispanic_or_latinx + identifies_as_black + age + how_often_officials_acting_in_your_interest, data = prison_cleaned)
